      ...
      <section id="pricing" className="py-24 relative">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-4">FAIR PRICING FOR ELITE SHOPS</h2>
            <p className="text-white/60">Choose the plan that fits your current scale.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="p-8 glass rounded-xl border border-white/10 hover:border-white/20 transition-all flex flex-col">
              ...
              <div className="text-4xl font-black mb-6">$29<span className="text-sm text-white/40 font-normal">/mo</span></div>
              ...
              <button className="w-full py-3 glass rounded-cyber font-bold hover:neon-border transition-all">Choose Plan</button>
            </div>
            ...
            <div className="p-8 glass rounded-xl border-accent border-2 relative scale-105 shadow-[0_0_40px_rgba(139,92,246,0.2)] flex flex-col">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-accent text-white px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest">Most Popular</div>
              <h3 className="text-xl font-bold mb-2">Pro</h3>
              <div className="text-4xl font-black mb-6">$89<span className="text-sm text-white/40 font-normal">/mo</span></div>
              <ul className="space-y-4 mb-8 flex-grow">
              ...
              <button className="w-full py-3 bg-accent text-white rounded-cyber font-bold hover:bg-neon transition-all">Scale Now</button>
            </div>

            {/* Enterprise */}
            <div className="p-8 glass rounded-xl border border-white/10 hover:border-white/20 transition-all flex flex-col">
              <h3 className="text-xl font-bold mb-2">Franchise</h3>
              <div className="text-4xl font-black mb-6">$199<span className="text-sm text-white/40 font-normal">/mo</span></div>
              <ul className="space-y-4 mb-8 flex-grow">
              ...
              <button className="w-full py-3 glass rounded-cyber font-bold hover:neon-border transition-all">Contact Sales</button>
            </div>
          </div>
        </div>
      </section>
